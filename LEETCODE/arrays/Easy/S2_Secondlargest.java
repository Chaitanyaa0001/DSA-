    ...
    private static  int secondlargest(int[] numbers){
        ...
        for(int  i = 0; i < n; i++){ 
            ...
            if(numbers[i] > largest){
                ...
                // ab agar meri current vi value largest to hai nhi 
                //  to matlab vo choti hai usse  ab check karo agar current 
                // ki value meri secordlargest se badi hai or largest  mei
                //  jo store tha vo vlaue or meri current same nhi hona 
                // chaoye for duplicates 
